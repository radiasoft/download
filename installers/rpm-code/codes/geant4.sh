...
install_d=${1:-}
if [[ ! $install_d ]]; then
    echo "usage: $0 dataset-install-directory
You must supply a directory where you want the datasets to be installed" 1>&2
    exit 1
fi
...
For example: GEANT4_DATA_DIR=$install_d ./exampleB1"
EOF
}
